...
const mockExams: Exam[] = [
  ...
  { id: '3', title: 'Klausur: Betriebssysteme', modul: 'Betriebssysteme', date:  '2025-09-244', professor: 'Prof. Dr. Eric Hutter', examType: 'Klausur' },
...
const Exams = () => {
  ...
  return (
    <Box sx={{ padding: 2, maxWidth: 1000, mx: 'auto' }}>
      <Typography level="h4">{t('pages.exams.title', { defaultValue: 'Prüfungsübersicht' })}</Typography>
      <ExamsOverview
        exams={mockExams}
        onSelect={(exam) => {
          // Replace with navigation or details drawer
